...
{
    /// <summary>
    ///     <see cref="IGameRulesCellVerifier" /> for a standard variant of Battleships game.
    ///     It checks if all <see cref="Cell" />s are adjacent and placed on the same axis
    /// </summary>
    public sealed class StandardBattleshipGameRulesCellVerifier : IGameRulesCellVerifier
    {
